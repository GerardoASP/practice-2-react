  ...
  render() {
    return (
      <div className="loader">
        ...
        <div className="options" id="options" ref={(options) => (this.optionsContainer = options)}>
          <div className="cubeX" id="twitter">
            <div className="front">
          ...
          <div className="cubeF" id="facebook">
            <div className="front">
              <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="cubeL" id="linkedin">
            <div className="front">
